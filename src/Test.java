...
public class Test {
  ...
  {  
      ...
      CalculAttributs_Old ca = new CalculAttributs_Old();
      ...
      Classifier cls = (Classifier) weka.core.SerializationHelper.read("models//DEFT15_T1_SMO.model");
        ...
        ConstructionARFF_Old obj = new ConstructionARFF_Old(ca);
        data = obj.ConstructionInstances(data,"polarity");
        int id=0;
        Instance inst;
