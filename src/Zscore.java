...
public class Zscore {
    ...
    throws Exception
  {
    BufferedReader r = new BufferedReader(new InputStreamReader(new FileInputStream("data/DebatPolitique/train.arff"), "UTF-8"));
    Instances train = new Instances(r);
    train.setClassIndex(train.numAttributes() - 1);
    Zscore z = new Zscore(train);
    z.BuildFile("ZscoreDikos/DebatPolitique");
  }
